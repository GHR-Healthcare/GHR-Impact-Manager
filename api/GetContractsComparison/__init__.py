    ...
    try:
        ...
        try:
            ...
            bh_cursor.execute('''
                ...
                LEFT JOIN dbo.View_CorporateUser recr   ON TRY_CAST(p.customText12 AS INT) = recr.corporateUserID
                LEFT JOIN dbo.View_CorporateUser am     ON TRY_CAST(p.customText11 AS INT) = am.corporateUserID
                WHERE p.isDeleted = 0
